...
export class ObrasController {
  ...
  getObraById = async (req, res) => {
    const obras = await this.Consultas.getObraById({
  ...
  getImagenes = async (req, res) => {
    const imagenes = await this.Consultas.getImagenes({
      dbType: req.params.dbType,
      id: req.params.id,
    });
  ...
  getImagenById = async (req, res) => {
    const imagen = await this.Consultas.getImagenById({
      dbType: req.params.dbType,
      id: req.params.id,
  ...
  addImagen = async (req, res) => {
    const imagen = await this.Consultas.addImagen({
      dbType: req.params.dbType,
      id: req.params.id,
      ruta: req.body.ruta,
    });
  ...
  addArtista = async (req, res) => {
    const artista = await this.Consultas.addArtista({
      dbType: req.params.dbType,
